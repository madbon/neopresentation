...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => 'Newly Elected Officials 2016',
    ...
    <ul id="my_submenu">
        ...
        <li class="second"><a href="<?= Url::to('index.php?r=tblofficials%2Fstatistics')?>"><i class="fa fa-bar-chart-o fa-fw"></i> Statistics</a></li>
    </ul>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("li.second").click(function(){
             $("li.second a").addClass('active');
            $("li.first a").removeClass('active');
        });
